						...
						<?php foreach ( $job_dashboard_columns as $key => $column ) : ?>
							<td class="<?php echo esc_attr( $key ); ?>">
											...
											switch ( $job->post_status ) {
												case 'publish' :
													...
													if ( is_position_filled( $job ) ) {
														$actions['mark_not_filled'] = array( 'label' => __( 'Mark Open', 'wp-job-manager' ), 'nonce' => true );
													} else {
														$actions['mark_filled'] = array( 'label' => __( 'Mark closed', 'wp-job-manager' ), 'nonce' => true );
													}
								...
								<?php elseif ('expires' === $key ) : ?>
									<?php echo get_the_project_deadline( $job ); ?>
