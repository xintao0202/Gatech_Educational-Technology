...
class WP_Job_Manager_Form_Submit_Job extends WP_Job_Manager_Form {
	...
	public function init_fields() {
		...
		switch ( $allowed_application_method ) {
			...
			break;
			default :
				$application_method_label       = __( 'Creator email/URL', 'wp-job-manager' );
		...
		$this->fields = apply_filters( 'submit_job_form_fields', array(
			'job' => array(
				'job_title' => array(
					'label'       => __( 'Project Name', 'wp-job-manager' ),
					'type'        => 'text',
					'required'    => true,
					'placeholder' => '',
					'priority'    => 1
				...
				'job_type' => array(
					'label'       => __( 'Project Field', 'wp-job-manager' ),
					'type'        => $job_type,
					'required'    => true,
					'placeholder' => __( 'Choose what field the project belongs to&hellip;', 'wp-job-manager' ),
					'priority'    => 3,
			...
			'company' => array(
				'company_name' => array(
					'label'       => __( 'Number of Participants', 'wp-job-manager' ),
					'type'        => 'text',
					'required'    => true,
					'placeholder' => __( 'Enter the number of minimum required participants', 'wp-job-manager' ),
					'priority'    => 1
				),
				'company_website' => array(
					...
					'type'        => 'text',
					'required'    => false,
					'placeholder' => __( 'Enter project external link', 'wp-job-manager' ),
					'priority'    => 2
				),
				'company_tagline' => array(
					'label'       => __( 'Required Knowledge', 'wp-job-manager' ),
					'type'        => 'text',
					'required'    => false,
					'placeholder' => __( 'Briefly describe knowledge required for the project', 'wp-job-manager' ),
					'maxlength'   => 64,
					'priority'    => 3
				),
				'company_video' => array(
					'label'       => __( 'Required Location', 'wp-job-manager' ),
					'type'        => 'text',
					'required'    => false,
					'placeholder' => __( 'Choose if participants need to be at specific location', 'wp-job-manager' ),
					'priority'    => 4
				),
				'company_twitter' => array(
					'label'       => __( 'Rewards', 'wp-job-manager' ),
					'type'        => 'text',
					'required'    => false,
					'placeholder' => __( 'Enter the amount of rewards for the winner', 'wp-job-manager' ),
					'priority'    => 5
				),
				'company_logo' => array(
					'label'       => __( 'Upload file', 'wp-job-manager' ),
					'type'        => 'file',
					'required'    => false,
					'placeholder' => '',
					'priority'    => 6,
	...
	protected function update_job_data( $values ) {
		...
		if ( is_user_logged_in() ) {
			...
			update_user_meta( get_current_user_id(), '_project_deadline', isset( $values['company']['project_deadline'] ) ? $values['company']['project_deadline'] : '' );
		}
